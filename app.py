...
STATIC_PATH = os.path.join(src_path, 'src/static')  #Change to /src/profiler/static when in WebsmartAPI repo
...
class MainHandler(BaseHandler):
    ...
    def post(self):
        ...
        my_dict_json = json_encode(my_dict)
...
APP_LIST = [
    (r"/", MainHandler)  #change to /profiler when committed to WebsmartAPI
]
